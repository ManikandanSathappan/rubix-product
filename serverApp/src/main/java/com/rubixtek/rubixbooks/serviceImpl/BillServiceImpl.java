...
public class BillServiceImpl implements BillService {
	...
	@Override
	public List<Bill> getBillsBySupplierWithDate(Supplier supplier, LocalDate billStartDate, LocalDate billEndDate) {
		List<Bill> listOfBill = null;

		if (billStartDate.isAfter(billEndDate) && (billEndDate.isBefore(billStartDate))) {
